...
Ext.ux.ScheduleActivitySelectionModel = function(config){
    ...
    this.addEvents(
     ...
     Ext.ux.ScheduleActivitySelectionModel.superclass.constructor.call(this);
};


Ext.extend(Ext.ux.ScheduleActivitySelectionModel, Ext.ux.AbstractScheduleSelectionModel,  {
    /**
    ...
    initEvents : function(){
        ...
        this.schedule.on("activitymousedown", this.handleMouseDown, this);
...
//        });
     ...
     * @param {Boolean} keepExisting (optional) True to keep existing selections
     */
    selectActivity : function(rowIndex, activityIndex, keepExisting, preventViewNotify){
        if(this.locked || (rowIndex < 0 || rowIndex >= this.schedule.store.getCount()) || this.isSelected(index)) return;
